...
var _productos = _interopRequireDefault(require("../api/productos"));
...
router.get('/productos/vista-test/:cant?', function (req, res) {
  var cant = req.query.cant ? Number(req.query.cant) : 10;
